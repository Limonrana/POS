                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control @error('buying_price') is-invalid @enderror" type="text" id="buying_price" name="buying_price" placeholder="200" required>
                                            @error('buying_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control  @error('selling_price') is-invalid @enderror" type="text" id="selling_price" name="selling_price" placeholder="320.95" required>
                                            @error('selling_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('code') is-invalid @enderror" id="code" name="code" placeholder="SKU-1234" type="text" required>
                                        @error('code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="intro" name="description" cols="30" rows="13"></textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
...
@section('admin-js')
    <script>
        ...
        function showImage(img) {
            ...
            document.querySelector('.image-complete').style.padding = "0px";
        ...
        function imgRemove() {
            ...
            document.querySelector('.image-complete').style.padding = "70px";
