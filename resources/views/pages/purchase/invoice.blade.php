        ...
        <div class="card-body">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto">
                    ...
                    <a href="{{ route('purchase.pdf', $invoice->id) }}" target="_blank" class="btn btn-falcon-success btn-sm mr-2 mb-2 mb-sm-0" type="button">
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    ...
                    <p class="fs--1">{{ $invoice->vendor->getAddress->street }}<br>{{ $invoice->vendor->getAddress->city }}, {{ $invoice->vendor->getAddress->state }}<br>{{ $invoice->vendor->getAddress->country }}</p>
                    <p class="fs--1"><a href="mailto:example@gmail.com">{{ $invoice->vendor->email }}</a><br><a href="tel:{{ $invoice->vendor->phone }}">{{ $invoice->vendor->phone }}</a></p>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-borderless fs--1">
                            ...
                            <tr>
                                ...
                                <td>{{ $invoice->vendor->getPayment->name }}</td>
                            </tr>
            ...
            <div class="table-responsive mt-4 fs--1">
                <table class="table table-striped border-bottom">
                    ...
                    <tbody>
                    @foreach($invoice->purchaseDetails as $val)
                    <tr>
