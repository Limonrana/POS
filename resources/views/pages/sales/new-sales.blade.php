...
@section('content')
        ...
        <div class="card-body">
            <div class="row justify-content-between align-items-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <h6 class="mb-0">DashBoard > Sales > Add New</h6>
                </div>
    ...
    <form class="sales" action="{{ route('sales.store') }}" method="post" enctype="multipart/form-data">
        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <div class="custom-control custom-radio radio-select">
                                        ...
                                        <a class="mt-2 fs--1 cart-remove" @click="customerRemove()">Remove</a></div>
                                </div>
                            </div>
                        </template>
                        <template v-else>
                                ...
                                <div class="row m-auto">
                                    <div class="col-9 col-md-9 col-lg-9">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" id="customer_id">
                                    ...
                                    <div class="col-3 col-md-3 col-lg-3 mt-pt">
                                        <button class="btn btn-falcon-default btn-md mt-2" type="button" @click="addCustomer()"><span class="fas fa-plus fs--2 mr-1" data-fa-transform="up-1"></span> Add Item</button>
                                    </div>
                                </div>
                            </div>
                        </template>
                                ...
                                <div class="row no-gutters align-items-center px-1 border-bottom border-200" v-for="(item, index) in cart">
                                    ...
                                    <div class="col-6 p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 d-flex justify-content-end justify-content-md-center px-2 px-md-3 order-1 order-md-0">
                                                <input class="form-control text-center px-2 input-quantity input-spin-none" :id="'price-'+item.id" type="number" min="1" :value="`${ item.price }`" v-on:change="priceUpdate(item.id)" style="max-width: 100px" />
                                            </div>
