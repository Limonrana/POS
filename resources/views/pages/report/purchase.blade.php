...
@section('title', 'Purchase Report | Inventory POS')
    ...
    <div class="purchase-report">
        <div class="media mb-4 mt-3"><span class="fa-stack mr-2 ml-n1"><i class="fas fa-circle fa-stack-2x text-300"></i> <i class="fa-inverse fa-stack-1x text-primary fas fa-percentage"></i></span>
            <div class="media-body">
                <h5 class="mb-0 text-primary position-relative"><span class="bg-200 pr-3">Purchase Report</span><span class="border position-absolute absolute-vertical-center w-100 z-index--1 l-0"></span></h5>
                <p class="mb-0">You can see your total purchase report from below.</p>
            </div>
        </div>
        ...
        <div class="card-deck">
            <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                    <h6>Total Purchase<span class="badge badge-soft-warning rounded-capsule ml-2">{{ ($yesterday_sales - $today_sales) == 0 ? '0.00' : number_format(($yesterday_sales - $today_sales) / $today_sales * 100, 2) }}%</span></h6>
            ...
            <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
                ...
                <!--/.bg-holder-->
                <div class="card-body position-relative">
                    <h6>Monthly Purchase<span class="badge badge-soft-info rounded-capsule ml-2">{{ ($prev_sales - $monthly_sales) == 0 ? '0.00' : number_format(($prev_sales - $monthly_sales) / $monthly_sales * 100, 2) }}%</span></h6>
            ...
            <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
                ...
                <!--/.bg-holder-->
                <div class="card-body position-relative">
                    <h6>Yearly Purchase<span class="badge badge-soft-success rounded-capsule ml-2">@if($yearly_sales != 0){{ ($prev_year - $yearly_sales) == 0 ? '0.00' : number_format(($prev_year - $yearly_sales) / $yearly_sales * 100, 2) }} @else 0.00 @endif%</span></h6>
        ...
        <template>
            <div class="card mb-3" v-show="purchaseData">
                <div class="card-header">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-6 col-sm-auto d-flex align-items-center pr-0">
                            <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">All Purchase</h5>
                        </div>
                ...
                <div class="card-body px-0 pt-0">
                    <div class="falcon-data-table">
                        <table class="table table-sm table-dashboard data-table no-wrap mb-0 fs--1 w-100" data-options='{"searching":false,"responsive":false,"pageLength":20,"info":true,"lengthChange":false,"sWrapper":"falcon-data-table-wrapper","dom":"<&#39;row mx-1&#39;<&#39;col-sm-12 col-md-6&#39;l><&#39;col-sm-12 col-md-6&#39;f>><&#39;table-responsive&#39;tr><&#39;row no-gutters px-1 py-3 align-items-center justify-content-center&#39;<&#39;col-auto&#39; p>>","language":{"paginate":{"next":"<span class=\"fas fa-chevron-right\"></span>","previous":"<span class=\"fas fa-chevron-left\"></span>"}}}'>
                            ...
                            <tr v-for="(item, index) in purchase">
        ...
        <template>
            <div class="card h-100 mb-3" v-show="!purchaseData">
                <div class="card-header">
                    <h5 class="mb-0">Search Purchase Report</h5>
                </div>
